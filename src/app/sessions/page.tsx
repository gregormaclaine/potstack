...
import { fetchPagedForUser } from '@/lib/unified-session';
...
export default async function SessionsPage({ searchParams }: PageProps) {
  ...
  const [{ sessions, total }, rawEvents, pendingInviteCount] = await Promise.all([
    fetchPagedForUser(userId, page, limit),
    prisma.event.findMany({ where: { userId }, orderBy: { startDate: 'desc' } }),
